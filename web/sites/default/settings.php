 ...
 * @endcode
 */
$settings['hash_salt'] = 'UEUCl6uaQBDpbwP2BLVmlcY9PCGl5ONTJ2ihy_aHX59nK33R1ycTgj1axPGfFXQM_3a9d4nE5Q';
...
$settings['config_sync_directory'] = 'sites/default/files/config__In7dmczJM0l0zNY8v_9MDLZFZGKVw7srqMw_7uoShwXak7HVLlWnNxEiikMCW74XTm0WDalkA/sync';
$settings['trusted_host_patterns'] = [
  '^localhost$',      
  '^127\.0\.0\.1$',
  ];